...
public class Upload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				String email=request.getSession().getAttribute("email1").toString();
				...
				String fullpath=editpath+"Dual_Server\\WebContent\\Local\\";
			...
			//file encrypted and store into filepath1
		             ...
		             filepath1 = editpath + "\\Dual_Server\\WebContent\\Encrypt\\"+filename;
		              ...
		              //file decrypted and store into filepath2
		        		    ...
		        		    filepath2 = editpath + "\\Dual_Server\\WebContent\\Decrypt\\"+filename;
